  ...
  <footer class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-lg font-bold mb-4">Virtuosa</h3>
          <p class="text-gray-400">
            Sua loja de moda feminina com estilo e elegância.
          </p>
        </div>
        ...
        <div>
          <h4 class="text-lg font-bold mb-4">Políticas</h4>
          <ul class="space-y-2">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            ...
            <a href="https://www.instagram.com/virtuosa_bf/" target="_blank" class="text-gray-400 hover:text-white">
              <span class="sr-only">Instagram</span>.netlify.app
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
        <p>&copy; 2024 Virtuosa. Todos os direitos reservados.</p>
      </div>
    </div>
  </footer>
</template>